...
<body>
 ...
 %></th>
		...
		<tbody>
			<%
				ResultSet rs = con.createStatement()
					.executeQuery("select * from product inner join cart on id=cart.product_id and cart.email='" + email
	...
	<%
		ResultSet rs2 = con.createStatement().executeQuery("select *from user where email='" + email + "'");
	while (rs2.next()) {
	%>

	<hr style="width: 100%">
	<form action="addressPaymentForOrderActionjsp.jsp" method="post">
		<div class="left-div">
			<h3>Enter Address</h3>
		...
		<h3 style="color: red">*Please set you address if the address box is empty!</h3>
		<h3 style="color: red">*This address will be updated to your
			profile</h3>
		<hr style="width: 100%">
		<div class="left-div">
		...
		<div class="right-div">
			<h3>Pay online on this shopera@pay.com</h3>
		...
		<div class="left-div">
			...
			<h3 style="color: red">*This mobile number will be updated to
				your profile</h3>
		</div>
		<div class="right-div">
			<h3 style="color: red">*Please don't enter wrong transaction id</h3>
			<button class="button" type="submit">Generate bill and Save <i class='far fa-arrow-alt-circle-right'></i></button>
